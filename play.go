...
// Decides whether the player of index <PlayerIndex> should take the card (true)
// or not (false). The enums for these bots are listed above.
...
func (p Player) decidePlay(gs *GameState) bool {
	...
	if p.Money == 0 {
		log.Println("NO MONEY, money: ", p.Money)
		return true
	}
