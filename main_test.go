...
func TestInitGame(t *testing.T) {
    ...
    want := GameState{
        ...
        Status: Status{
            ...
            Money: 0,
            Players: []Player{
                { Money: 11, Name: "ure", Cards: [][]uint16{} },
                { Money: 11, Name: "KoodiKonna-77", Cards: [][]uint16{} },
                { Money: 11, Name: "PähkinäPomo X10", Cards: [][]uint16{} },
                { Money: 11, Name: "BittiBotti-6000", Cards: [][]uint16{} },
            },
            CardsLeft: 24,
            Finished: false,
        },
